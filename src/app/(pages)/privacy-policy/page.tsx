  ...
  return (
    <>
      ...
      <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
        <p>Effective Date: Wed 6 Sep 2024</p>
        <p>
          At Convertall, we are committed to safeguarding your privacy. This
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            support@convertall.com.
          </p>
        </div>

        <p>
          By using Convertall, you agree to the practices outlined in this Privacy
