  ...
  return (
    <>
      ...
      <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
        <p>
          Introducing Convertall, the ultimate multimedia conversion powerhouse
        ...
        <div className="space-y-2">
          ...
          <p>
            Access Convertall from any device with an internet connection.
        ...
        <div className="space-y-2">
          <h2 className="text-xl md:text-2xl font-medium text-gray-700">
            🌟 It&apos;s Free, It&apos;s Powerful, It&apos;s Convertall:
          </h2>
          <p>
